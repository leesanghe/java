...
import ch14_jdbc_conn.model.NoticeVo;
...
public class UserDao {
	...
	//---------------------------------------
	public ArrayList<NoticeVo> bbsList(Connection conn) throws SQLException{
		ArrayList<NoticeVo> bbsList= new ArrayList<NoticeVo>();
		StringBuffer query  =new StringBuffer();
		
		query.append("select * ");
		query.append("       , from bbs");
		query.append("       , START WITH bbs_no =41");
